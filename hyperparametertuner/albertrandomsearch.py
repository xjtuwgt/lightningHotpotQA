...
def HypeParameterSpace():
    learning_rate = {'name': 'learning_rate', 'type': 'choice', 'values': [5e-6, 1e-5, 1.5e-5, 2e-5]} #3e-5, 5e-5, 1e-4, 1.5e-4
    ...
    gnn = {'name': 'gnn', 'type': 'choice', 'values': ['gat:1,4']} ##'gat:1,2' 'gat:1,4'ho
