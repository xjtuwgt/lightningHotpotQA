...
from jdmodels.jdUnifiedHGN import UnifiedHierarchicalGraphNetwork
...
model = UnifiedHierarchicalGraphNetwork(config=args)
...
#         start, end, q_type, paras, sents, ents, y1, y2 = model.forward(batch, return_yp=True)
