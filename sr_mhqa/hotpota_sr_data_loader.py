...
class HotpotDataset(Dataset):
    def __init__(self, examples, sep_token_id, max_para_num=4, max_sent_num=100,
                 max_seq_num=512, sent_replace_ratio=0.25, replace_prob=0.5):
        self.examples = examples
        self.max_para_num = max_para_num
        self.max_sent_num = max_sent_num
        self.max_seq_length = max_seq_num
        self.sep_token_id = sep_token_id
        self.sent_replace_ratio = sent_replace_ratio
    ...
    def __getitem__(self, idx):
        ...
        #++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        trim_sent_replace_id = sent_replace_ids[:trim_sent_num]
        trim_sent_replace_id += [0] * sent_pad_num
        #++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        ...
        assert len(trim_sent_replace_id) == self.max_sent_num
        ...
        ##+++++++++++++++++++++++
        trim_sent_replace_flags = torch.LongTensor(trim_sent_replace_id)
        ##+++++++++++++++++++++++
        res = {'ids': id,
               'y1': y1,
               'y2': y2,
               ...
               'sent_replace_flag': trim_sent_replace_flags,
