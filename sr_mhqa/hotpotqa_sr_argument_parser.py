...
def default_train_parser():
    ...
    parser.add_argument("--sent_replace_ratio", type=float, default=0.25)
    parser.add_argument("--replace_prob", type=float, default=0.25)
    parser.add_argument("--sent_replace_lambda", type=float, default=1)
    ##++++++++++++++++++

    return parser

def default_dev_parser():
    parser = argparse.ArgumentParser()
    ...
    # train-dev data type
    parser.add_argument("--daug_type", default='hgn_low', type=str, help="Train Data augumentation type.")
    parser.add_argument("--devf_type", default='hgn_low', type=str, help="Dev data type")
