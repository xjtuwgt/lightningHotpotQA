...
#    INPUTS=("hotpot_train_v1.1.json;train")
    for input in ${INPUTS[*]}; do
        ...
        python hgnrankerDataUtils/hgnmodel_multihop_ps.py $INPUT_FILE $OUTPUT_PROCESSED/doc_link_ner.json $OUTPUT_PROCESSED/ner.json $OUTPUT_PROCESSED/rerank_alberttopk_3_hgn_low_para_ranking.json $OUTPUT_PROCESSED/rerank_alberttopk_3_hgn_low_multihop_para.json $SELECTEED_DOC_NUM
