...
def train_parser():
    ...
    parser.add_argument("--span_window_size", type=int, default=150, help='span_window_size')
    parser.add_argument("--decoder_window_size", type=int, default=200, help='span_window_size')
