...
class DataHelper:
    ...
    def train_feature_file(self):
        return self.get_feature_file('train_post', self.train_f_type)

    @property
    def dev_feature_file(self):
        return self.get_feature_file('dev_distractor_post', self.config.devf_type)

    @property
    def train_example_file(self):
        return self.get_example_file('train_post', self.train_f_type)

    @property
    def dev_example_file(self):
        return self.get_example_file('dev_distractor_post', self.config.devf_type)

    @property
    def train_graph_file(self):
        return self.get_graph_file('train_post', self.train_f_type)

    @property
    def dev_graph_file(self):
        return self.get_graph_file('dev_distractor_post', self.config.devf_type)
