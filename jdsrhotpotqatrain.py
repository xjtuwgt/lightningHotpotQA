...
from sr_mhqa.hotpotqa_sr_argument_parser import default_train_parser, complete_default_train_parser, json_to_argv
from csr_mhqa.utils import MODEL_CLASSES
from sr_mhqa.hotpotqa_sr_datahelper import DataHelper
from sd_mhqa.hotpotqa_evalutils import jd_hotpotqa_eval_model
from sr_mhqa.hotpotqa_sr_model import UnifiedSRModel
...
model = UnifiedSRModel(config=args)
