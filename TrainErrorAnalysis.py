...
if __name__ == '__main__':
    ...
    parser.add_argument("--pred_res_name", default='train_pred.json', type=str, help="Prediction result")

    parser.add_argument("--pred_score_name", default='train_score.json', type=str, help="Prediction result")

    parser.add_argument("--error_res_name", default='error_train_res.json', type=str, help="error analysis result")
