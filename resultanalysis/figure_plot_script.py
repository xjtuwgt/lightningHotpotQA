...
json_file_name = 'hgn_low_saeerror_train_res.json'
...
def show_min_max_score_range(data):
    min_positive_scores = data['min_p'].to_numpy()
    max_negative_scores = data['max_n'].to_numpy()
