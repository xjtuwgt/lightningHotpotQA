...
for batch_idx, batch in enumerate(dev_loader):
    ...
    for idx, id in enumerate(ids):
        ...
        print(batch['para_mapping'][idx], batch['para_mapping'][idx].shape)
        print(batch['sent_mapping'][idx], batch['sent_mapping'][idx].shape)
        print(batch['ent_mapping'][idx], batch['ent_mapping'].shape)
