...
from sd_mhqa.hotpotqa_data_loader import HotpotTestDataset, HotpotDataset
...
from sd_mhqa.hotpotqaUtils import case_to_features, example_sent_drop, trim_input_span
...
def data_loader_checker(para_file: str,
    ...
    hotpotdata = HotpotDataset(examples=examples, sep_token_id=tokenizer.sep_token_id, sent_drop_ratio=0.5)
